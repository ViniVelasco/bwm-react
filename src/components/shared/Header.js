...
class Header extends React.Component {
  ...
  renderAuthButtons(isAuth) {
    if(isAuth) {
      return (
        <a className='nav-item nav-link' onClick={this.handleLogout}>Logout</a>
      )
    }
    ...
    if(isAuth) {
      return (
        <div className="nav-item dropdown">
          <a className="nav-link nav-item dropdown-toggle clickabe" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            Owner Section
          </a>
